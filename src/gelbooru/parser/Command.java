...
public class Command {
	...
	public static void help() {
		...
		System.out.println("show                    - shows all saved keys in data.json");
		System.out.println("rm    [key]             - remove a key from data.json");
	...
	public static void path() {
		System.out.println(App.data.getAbsolutePath());
	}
	...
	public static void load(String key, int id, boolean rw) {
		try {
			...
			new FileWriter(App.data, false).close();
			jo.write(writer);
